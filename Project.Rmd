...
for (filename in c("data2017", "data2018", "data2019", "data2020")) {
  ...
  num_vec = paste0(get_letter(filename), c("_age", "j13.2", "j13", "j8", "j72.173", "_inwgt", "_hhwgt", "f14", "j10"))
  ...
  df = df %>% rename_with(.fn = ~c("origsm", "inwgt", "occup08","marst","diplom", "age", "h5", "sat_job", "sat_con", "sat_pay", "sat_prom", "jstat", "jcode08", "industry", "j6", "i4", "j8", "j8_1", "j13", "j13_2", "j26", "j29c_1", "j29c_2", "j22", "j31", "j32", "children", "m3", "id_h", "j10", "hhwgt", "c1", "f14", "j11", "j11_1", "j21_3", "j23")
  ...
  origdf$newname <- c("origsm", "inwgt", "occupation","marital","educ", "age", "male", "sat_job", "sat_con", "sat_pay", "sat_prom", "jstat", "jcode08", "industry", "supervisor", "nationality", "log_hours", "at_home", "est_size", "log_avgincome", "owner", "emp_trust", "col_trust", "job_search", "job_lose", "other_job", "children", "health", "id_h", "log_lastincome", "hhwgt", "renter", "f14", "j11", "contract", "hazardous", "govt", "region")
